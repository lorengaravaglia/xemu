...
typedef struct NetdevPcapOptions NetdevPcapOptions;
...
void qapi_free_NetdevPcapOptions(NetdevPcapOptions *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(NetdevPcapOptions, qapi_free_NetdevPcapOptions)
