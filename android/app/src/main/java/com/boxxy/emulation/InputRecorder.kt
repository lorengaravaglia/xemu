...
import com.boxxy.NativeInterface
import java.io.File
...
object InputRecorder {
    ...
    const val ACTION_PLAY          = "com.boxxy.action.PLAY_RECORDING"
    const val ACTION_STOP_PLAYBACK = "com.boxxy.action.STOP_PLAYBACK"
    const val ACTION_BENCHMARK     = "com.boxxy.action.BENCHMARK"
    const val ACTION_LOAD_STATE    = "com.boxxy.action.LOAD_STATE"
